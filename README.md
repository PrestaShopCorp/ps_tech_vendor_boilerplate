...
- `languages`: The list of languages available in the shop (read only)
- `manufacturers`: The list of brands available in the shop (read only)
...
- `suppliers`: The list of suppliers in the shop (read only)
